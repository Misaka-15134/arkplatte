...
本项目的'akp.arkplatte_cell'函数针对单细胞配色进行了特化增强，以及包含多个角色配色的合理化欢迎其它粥友为其它你们常用到复杂任务配色提供idea和代码贡献！

目前仍在完善中，后续会考虑增加阵营配色，以提前备战下一季的卫戍协议（bushi）卫啊我的卫！！！

有任何问题欢迎提在issue里，看到了我就修一下
